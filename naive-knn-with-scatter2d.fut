...
entry main [m] [d] (imA : [m][d]f32) (imB : [m][d]f32) (h: i32) =
  ...
  -- let sorted_knns = zip (comp_knns_idxs :> [m]i32) (completed_knn :> [m][k]f32) |> radix_sort_int_by_key (.0) i32.num_bits i32.get_bit

  in (median_vals, median_dims, not_completed_queries, completed_knn, visited) --, sorted_knns)
