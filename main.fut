...
-- compiled input @ data/traverse/13test-k3-d14.in
-- compiled input @ data/traverse/13test-k5-d14.in
...
-- compiled input @ data/sorting/10test-k11-d9.in
...
entry main [a][b][d] (k: i32) (h: i32) (imA : [a][d]f32) (imB : [b][d]f32) =
