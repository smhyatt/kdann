                                           ...
                                           unsigned char *srcmem_2)
{
    ...
    if (slt32(x_index_31, y_elems_6) && (slt32(y_index_32, x_elems_5) &&
        ...
        ((__global double *) destmem_0)[odata_offset_33 + index_out_36] =
            ((__local double *) block_11)[get_local_id_0_38 * 17 +
                                          get_local_id_1_39];
    }
}
...
__kernel void segmap_5377(int32_t m_5333, int32_t n_5336, int32_t n_5339,
                          __global unsigned char *imB_mem_5410, __global
                          unsigned char *mem_5414, __global
                          unsigned char *mem_5417)
{
    const int32_t segmap_group_sizze_5380 = mainzisegmap_group_sizze_5379;
    const int block_dim0 = 0;
    const int block_dim1 = 1;
    const int block_dim2 = 2;
    int32_t global_tid_5422;
    int32_t local_tid_5423;
    int32_t group_sizze_5426;
    int32_t wave_sizze_5425;
    int32_t group_tid_5424;
    
    global_tid_5422 = get_global_id(0);
    local_tid_5423 = get_local_id(0);
    group_sizze_5426 = get_local_size(0);
    wave_sizze_5425 = LOCKSTEP_WIDTH;
    group_tid_5424 = get_group_id(0);
    
    int32_t phys_tid_5377 = global_tid_5422;
    int32_t gtid_5376 = group_tid_5424 * segmap_group_sizze_5380 +
            local_tid_5423;
    
    if (slt32(gtid_5376, m_5333)) {
        double res_5385;
        double redout_5401 = INFINITY;
        
        for (int32_t i_5402 = 0; i_5402 < m_5333; i_5402++) {
            double res_5390;
            double redout_5403 = 0.0;
            
            for (int32_t i_5404 = 0; i_5404 < n_5339; i_5404++) {
                double x_5394 = ((__global double *) mem_5414)[i_5404 * m_5333 +
                                                               gtid_5376];
                double x_5395 = ((__global double *) imB_mem_5410)[i_5402 *
                                                                   n_5336 +
                                                                   i_5404];
                double x_5396 = x_5394 - x_5395;
                double res_5397 = x_5396 * x_5396;
                double res_5393 = res_5397 + redout_5403;
                double redout_tmp_5428 = res_5393;
                
                redout_5403 = redout_tmp_5428;
            }
            res_5390 = redout_5403;
            
            double res_5398;
            
            res_5398 = futrts_sqrt64(res_5390);
            
            double res_5388 = fmin64(res_5398, redout_5401);
            double redout_tmp_5427 = res_5388;
            
            redout_5401 = redout_tmp_5427;
        }
        res_5385 = redout_5401;
        ((__global double *) mem_5417)[gtid_5376] = res_5385;
    }
}
"""
# Start of values.py.
...
class brute:
  ...
  def __init__(self, command_queue=None, interactive=False,
    ...
    program = initialise_opencl_object(self,
                                       ...
                                       required_types=["i32", "f64"],
                                       user_sizes=sizes,
                                       all_sizes={"main.segmap_group_size_5379": {"class": "group_size", "value": None}})
    ...
    self.segmap_5377_var = program.segmap_5377
  def futhark_main(self, imA_mem_5409, imB_mem_5410, m_5333, n_5334, m_5335,
                   n_5336):
    n_5339 = smax32(n_5334, n_5336)
    dim_zzero_5340 = (np.int32(0) == m_5333)
    dim_zzero_5341 = (np.int32(0) == n_5334)
    old_empty_5342 = (dim_zzero_5340 or dim_zzero_5341)
    dim_zzero_5343 = (np.int32(0) == n_5339)
    new_empty_5344 = (dim_zzero_5340 or dim_zzero_5343)
    both_empty_5345 = (old_empty_5342 and new_empty_5344)
    dim_match_5346 = (n_5339 == n_5334)
    empty_or_match_5347 = (both_empty_5345 or dim_match_5346)
    empty_or_match_cert_5348 = True
    assert empty_or_match_5347, ("Error at brute.fut:12:1-20:9: %s" % ("function arguments of wrong shape",))
    dim_zzero_5350 = (np.int32(0) == m_5335)
    dim_zzero_5351 = (np.int32(0) == n_5336)
    old_empty_5352 = (dim_zzero_5350 or dim_zzero_5351)
    both_empty_5353 = (new_empty_5344 and old_empty_5352)
    dim_match_5354 = (m_5333 == m_5335)
    dim_match_5355 = (n_5339 == n_5336)
    match_5356 = (dim_match_5354 and dim_match_5355)
    empty_or_match_5357 = (both_empty_5353 or match_5356)
    empty_or_match_cert_5358 = True
    assert empty_or_match_5357, ("Error at brute.fut:12:1-20:9: %s" % ("function arguments of wrong shape",))
    segmap_group_sizze_5380 = self.sizes["main.segmap_group_size_5379"]
    y_5381 = (segmap_group_sizze_5380 - np.int32(1))
    x_5382 = (m_5333 + y_5381)
    segmap_usable_groups_5383 = squot32(x_5382, segmap_group_sizze_5380)
    convop_x_5412 = (m_5333 * n_5334)
    binop_x_5413 = sext_i32_i64(convop_x_5412)
    bytes_5411 = (np.int64(8) * binop_x_5413)
    mem_5414 = opencl_alloc(self, bytes_5411, "mem_5414")
    self.futhark__map_transpose_f64(mem_5414, np.int32(0), imA_mem_5409,
                                    np.int32(0), np.int32(1), n_5334, m_5333,
                                    (m_5333 * n_5334), (m_5333 * n_5334))
    binop_x_5416 = sext_i32_i64(m_5333)
    bytes_5415 = (np.int64(8) * binop_x_5416)
    mem_5417 = opencl_alloc(self, bytes_5415, "mem_5417")
    if ((1 * (np.long(segmap_usable_groups_5383) * np.long(segmap_group_sizze_5380))) != 0):
      self.segmap_5377_var.set_args(np.int32(m_5333), np.int32(n_5336),
                                    np.int32(n_5339), imB_mem_5410, mem_5414,
                                    mem_5417)
      cl.enqueue_nd_range_kernel(self.queue, self.segmap_5377_var,
                                 ((np.long(segmap_usable_groups_5383) * np.long(segmap_group_sizze_5380)),),
                                 (np.long(segmap_group_sizze_5380),))
      if synchronous:
        self.queue.finish()
    mem_5414 = None
    out_arrsizze_5421 = m_5333
    out_mem_5420 = mem_5417
    return (out_mem_5420, out_arrsizze_5421)
  def futhark__map_transpose_f64(self, destmem_0, destoffset_1, srcmem_2,
      ...
      if ((in_elems_7 == out_elems_8) and (((num_arrays_4 == np.int32(1)) or ((x_elems_5 * y_elems_6) == in_elems_7)) and ((x_elems_5 == np.int32(1)) or (y_elems_6 == np.int32(1))))):
        ...
        if (sle32(x_elems_5, np.int32(8)) and slt32(np.int32(16), y_elems_6)):
          if ((((1 * (np.long(squot32(((x_elems_5 + np.int32(16)) - np.int32(1)),
            ...
            self.map_transpose_f64_low_width_var.set_args(np.int32(destoffset_1),
          ...
          if (sle32(y_elems_6, np.int32(8)) and slt32(np.int32(16), x_elems_5)):
            if ((((1 * (np.long(squot32(((squot32(((x_elems_5 + mulx_9) - np.int32(1)),
                                        ...
                                        np.int32(16))) * np.long(np.int32(16)))) * (np.long(squot32(((y_elems_6 + np.int32(16)) - np.int32(1)),
                                                                                                    np.int32(16))) * np.long(np.int32(16)))) * (np.long(num_arrays_4) * np.long(np.int32(1)))) != 0):
              self.map_transpose_f64_low_height_var.set_args(np.int32(destoffset_1),
                                                             np.int32(srcoffset_3),
                                                             np.int32(num_arrays_4),
                                                             np.int32(x_elems_5),
                                                             np.int32(y_elems_6),
            ...
            if (sle32(x_elems_5, np.int32(8)) and sle32(y_elems_6,
              ...
              if ((1 * (np.long(squot32(((((num_arrays_4 * x_elems_5) * y_elems_6) + np.int32(256)) - np.int32(1)),
                ...
                self.map_transpose_f64_small_var.set_args(np.int32(destoffset_1),
                                                          np.int32(srcoffset_3),
                                                          np.int32(num_arrays_4),
                                                          np.int32(x_elems_5),
                                                          np.int32(y_elems_6),
              ...
              if ((((1 * (np.long(squot32(((x_elems_5 + np.int32(32)) - np.int32(1)),
                ...
                self.map_transpose_f64_var.set_args(np.int32(destoffset_1),
                                                    np.int32(srcoffset_3),
                                                    np.int32(num_arrays_4),
                                                    np.int32(x_elems_5),
                                                    np.int32(y_elems_6),
                ...
                if synchronous:
                  self.queue.finish()
    return ()
  def main(self, imA_mem_5409_ext, imB_mem_5410_ext):
    try:
      assert ((type(imA_mem_5409_ext) in [np.ndarray,
                                          cl.array.Array]) and (imA_mem_5409_ext.dtype == np.float64)), "Parameter has unexpected type"
      m_5333 = np.int32(imA_mem_5409_ext.shape[0])
      n_5334 = np.int32(imA_mem_5409_ext.shape[1])
      if (type(imA_mem_5409_ext) == cl.array.Array):
        imA_mem_5409 = imA_mem_5409_ext.data
      else:
        imA_mem_5409 = opencl_alloc(self, np.int64(imA_mem_5409_ext.nbytes),
                                    "imA_mem_5409")
        if (np.int64(imA_mem_5409_ext.nbytes) != 0):
          cl.enqueue_copy(self.queue, imA_mem_5409,
                          normaliseArray(imA_mem_5409_ext),
                          is_blocking=synchronous)
    except (TypeError, AssertionError) as e:
      raise TypeError("Argument #0 has invalid value\nFuthark type: {}\nArgument has Python type {} and value: {}\n".format("[][]f64",
                                                                                                                            type(imA_mem_5409_ext),
                                                                                                                            imA_mem_5409_ext))
    try:
      assert ((type(imB_mem_5410_ext) in [np.ndarray,
                                          cl.array.Array]) and (imB_mem_5410_ext.dtype == np.float64)), "Parameter has unexpected type"
      m_5335 = np.int32(imB_mem_5410_ext.shape[0])
      n_5336 = np.int32(imB_mem_5410_ext.shape[1])
      if (type(imB_mem_5410_ext) == cl.array.Array):
        imB_mem_5410 = imB_mem_5410_ext.data
      else:
        imB_mem_5410 = opencl_alloc(self, np.int64(imB_mem_5410_ext.nbytes),
                                    "imB_mem_5410")
        if (np.int64(imB_mem_5410_ext.nbytes) != 0):
          cl.enqueue_copy(self.queue, imB_mem_5410,
                          normaliseArray(imB_mem_5410_ext),
                          is_blocking=synchronous)
    except (TypeError, AssertionError) as e:
      raise TypeError("Argument #1 has invalid value\nFuthark type: {}\nArgument has Python type {} and value: {}\n".format("[][]f64",
                                                                                                                            type(imB_mem_5410_ext),
                                                                                                                            imB_mem_5410_ext))
    (out_mem_5420, out_arrsizze_5421) = self.futhark_main(imA_mem_5409,
                                                          imB_mem_5410, m_5333,
                                                          n_5334, m_5335,
                                                          n_5336)
    return cl.array.Array(self.queue, (out_arrsizze_5421,), ct.c_double,
                          data=out_mem_5420)