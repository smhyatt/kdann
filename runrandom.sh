...
futhark dataget main.fut "17i32 8i32 [100000][8]f32 [100000][8]f32"   | ./main -t /dev/stderr  >>  $outputpath/"17-8-100000.txt"
futhark dataget main.fut "17i32 8i32 [100000][16]f32 [100000][16]f32" | ./main -t /dev/stderr  >>  $outputpath/"17-16-100000.txt"
