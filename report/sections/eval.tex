...
\begin{figure}[H]
  \centering
  \subfloat[D=16, K=3 and K=11.]{\includegraphics[width=0.49\textwidth]{pics/plot-figs/sort-d16.png}\label{fig:f1}}
  % \hfill
  % \hspace{0.cm}
  \subfloat[D=4, K=3 and K=11.]{\includegraphics[width=0.5\textwidth]{pics/plot-figs/sort-d4.png}\label{fig:f2}}
