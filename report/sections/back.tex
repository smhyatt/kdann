...
We have D dimensional space, we have a set of reference points of size n, and a set of queries of size m and we aim to compute the nearest neighbours according to a measured distance for each query. 
\\[2mm]
