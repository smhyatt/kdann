...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    struct futhark_f64_2d *read_value_5535;
    int64_t read_shape_5536[2];
    double *read_arr_5537 = NULL;
    
    errno = 0;
    if (read_array(&f64_info, (void **) &read_arr_5537, read_shape_5536, 2) !=
        0)
        panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 0, "[][]",
              f64_info.type_name, strerror(errno));
    
    struct futhark_f64_2d *read_value_5538;
    int64_t read_shape_5539[2];
    double *read_arr_5540 = NULL;
    
    errno = 0;
    if (read_array(&f64_info, (void **) &read_arr_5540, read_shape_5539, 2) !=
        0)
        panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 1, "[][]",
              f64_info.type_name, strerror(errno));
    
    struct futhark_f64_1d *result_5541;
    ...
    if (perform_warmup) {
        ...
        assert((read_value_5535 = futhark_new_f64_2d(ctx, read_arr_5537,
                                                     read_shape_5536[0],
                                                     read_shape_5536[1])) != 0);
        assert((read_value_5538 = futhark_new_f64_2d(ctx, read_arr_5540,
                                                     read_shape_5539[0],
                                                     read_shape_5539[1])) != 0);
        assert(futhark_context_sync(ctx) == 0);
        t_start = get_wall_time();
        r = futhark_entry_main(ctx, &result_5541, read_value_5535,
                               read_value_5538);
        if (r != 0)
        ...
        assert(futhark_free_f64_2d(ctx, read_value_5535) == 0);
        assert(futhark_free_f64_2d(ctx, read_value_5538) == 0);
        assert(futhark_free_f64_1d(ctx, result_5541) == 0);
    }
    time_runs = 1;
    /* Proper run. */
        ...
        set_binary_mode(stdout);
    {
        ...
        assert(arr != NULL);
        assert(futhark_values_f64_1d(ctx, result_5541, arr) == 0);
        write_array(stdout, binary_output, &f64_info, arr,
                    futhark_shape_f64_1d(ctx, result_5541), 1);
        free(arr);
    }
    printf("\n");
    assert(futhark_free_f64_1d(ctx, result_5541) == 0);
...
static int futrts_main(struct futhark_context *ctx,
                       struct memblock *out_mem_p_5533,
                       int32_t *out_out_arrsizze_5534,
                       struct memblock imA_mem_5521,
                       struct memblock imB_mem_5522, int32_t m_5466,
                       int32_t n_5467, int32_t m_5468, int32_t n_5469);
...
static int futrts_main(struct futhark_context *ctx,
                       ...
                       int32_t n_5467, int32_t m_5468, int32_t n_5469)
{
    struct memblock out_mem_5528;
    
    out_mem_5528.references = NULL;
    
    int32_t out_arrsizze_5529;
    int32_t n_5472 = smax32(n_5467, n_5469);
    bool dim_zzero_5473 = 0 == m_5466;
    bool dim_zzero_5474 = 0 == n_5467;
    bool old_empty_5475 = dim_zzero_5473 || dim_zzero_5474;
    bool dim_zzero_5476 = 0 == n_5472;
    bool new_empty_5477 = dim_zzero_5473 || dim_zzero_5476;
    bool both_empty_5478 = old_empty_5475 && new_empty_5477;
    bool dim_match_5479 = n_5472 == n_5467;
    bool empty_or_match_5480 = both_empty_5478 || dim_match_5479;
    bool empty_or_match_cert_5481;
    
    if (!empty_or_match_5480) {
        ctx->error = msgprintf("Error at %s:\n%s\n", "brute.fut:21:1-23:19",
                               "function arguments of wrong shape");
        if (memblock_unref(ctx, &out_mem_5528, "out_mem_5528") != 0)
            return 1;
        return 1;
    }
    
    bool dim_zzero_5483 = 0 == m_5468;
    bool dim_zzero_5484 = 0 == n_5469;
    bool old_empty_5485 = dim_zzero_5483 || dim_zzero_5484;
    bool both_empty_5486 = new_empty_5477 && old_empty_5485;
    bool dim_match_5487 = m_5466 == m_5468;
    bool dim_match_5488 = n_5472 == n_5469;
    bool match_5489 = dim_match_5487 && dim_match_5488;
    bool empty_or_match_5490 = both_empty_5486 || match_5489;
    bool empty_or_match_cert_5491;
    
    if (!empty_or_match_5490) {
        ctx->error = msgprintf("Error at %s:\n%s\n", "brute.fut:21:1-23:19",
                               "function arguments of wrong shape");
        if (memblock_unref(ctx, &out_mem_5528, "out_mem_5528") != 0)
            return 1;
    ...
    int64_t binop_x_5524 = sext_i32_i64(m_5466);
    int64_t bytes_5523 = 8 * binop_x_5524;
    struct memblock mem_5525;
    
    mem_5525.references = NULL;
    if (memblock_alloc(ctx, &mem_5525, bytes_5523, "mem_5525"))
        return 1;
    for (int32_t i_5515 = 0; i_5515 < m_5466; i_5515++) {
        double res_5495;
        double redout_5511 = INFINITY;
        
        for (int32_t i_5512 = 0; i_5512 < m_5466; i_5512++) {
            double res_5500;
            double redout_5509 = 0.0;
            
            for (int32_t i_5510 = 0; i_5510 < n_5472; i_5510++) {
                double x_5504 = ((double *) imA_mem_5521.mem)[i_5515 * n_5467 +
                                                              i_5510];
                double x_5505 = ((double *) imB_mem_5522.mem)[i_5512 * n_5469 +
                                                              i_5510];
                double x_5506 = x_5504 - x_5505;
                double res_5507 = fpow64(x_5506, 2.0);
                double res_5503 = res_5507 + redout_5509;
                double redout_tmp_5532 = res_5503;
                
                redout_5509 = redout_tmp_5532;
            }
            res_5500 = redout_5509;
            
            double res_5508;
            
            res_5508 = futrts_sqrt64(res_5500);
            
            double res_5498 = fmin64(res_5508, redout_5511);
            double redout_tmp_5531 = res_5498;
            
            redout_5511 = redout_tmp_5531;
        }
        res_5495 = redout_5511;
        ((double *) mem_5525.mem)[i_5515] = res_5495;
    }
    out_arrsizze_5529 = m_5466;
    if (memblock_set(ctx, &out_mem_5528, &mem_5525, "mem_5525") != 0)
        return 1;
    (*out_mem_p_5533).references = NULL;
    if (memblock_set(ctx, &*out_mem_p_5533, &out_mem_5528, "out_mem_5528") != 0)
        return 1;
    *out_out_arrsizze_5534 = out_arrsizze_5529;
    if (memblock_unref(ctx, &mem_5525, "mem_5525") != 0)
        return 1;
    if (memblock_unref(ctx, &out_mem_5528, "out_mem_5528") != 0)
        return 1;
    return 0;
                       ...
                       struct futhark_f64_2d *in1)
{
    ...
    imA_mem_5521.references = NULL;
    
    struct memblock imB_mem_5522;
    
    imB_mem_5522.references = NULL;
    ...
    lock_lock(&ctx->lock);
    imA_mem_5521 = in0->mem;
    m_5466 = in0->shape[0];
    n_5467 = in0->shape[1];
    imB_mem_5522 = in1->mem;
    m_5468 = in1->shape[0];
    n_5469 = in1->shape[1];
    
    int ret = futrts_main(ctx, &out_mem_5528, &out_arrsizze_5529, imA_mem_5521,
                          imB_mem_5522, m_5466, n_5467, m_5468, n_5469);
    
    if (ret == 0) {
        assert((*out0 =
                (struct futhark_f64_1d *) malloc(sizeof(struct futhark_f64_1d))) !=
            NULL);
        (*out0)->mem = out_mem_5528;
        (*out0)->shape[0] = out_arrsizze_5529;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
